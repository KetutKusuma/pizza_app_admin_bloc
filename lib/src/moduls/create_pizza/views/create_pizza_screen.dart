...
import 'package:pizza_app_admin_bloc/src/moduls/create_pizza/components/macros.dart';
  ...
  Widget build(BuildContext context) {
    return BlocListener<CreatePizzaBloc, CreatePizzaState>(
      ...
      child: BlocListener<UploadPictureBloc, UploadPictureState>(
        listener: (context, state) {
          if (state is UploadPictureProcess) {
          } else if (state is UploadPictureSuccess) {
            print("URL IMAGE : ${state.url}");
            setState(() {
              pizza.picture = state.url;
              print("PIZZA PICTURE : ${pizza.picture}");
            });
          }
        },
        child: Scaffold(
                    ...
                    child: pizza.picture.startsWith(('http'))
                        ...
                        : Ink(
                            ...
                            child: Column(
                              ...
                              children: [
                                Image.network(
                                    "https://firebasestorage.googleapis.com/v0/b/ketut-pizza-app.appspot.com/o/c1edf1ef-dc7f-4375-8c17-878ae27eafc8?alt=media&token=1bcc2a72-3f2f-450b-945d-e40dc2e39876"),
                                Icon(
